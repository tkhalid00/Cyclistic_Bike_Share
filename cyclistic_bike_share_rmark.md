...
![](cyclistic_bike_share_rmark_files/figure-html/missing-values-check-Amelia-1.png)<!-- -->
...
![](cyclistic_bike_share_rmark_files/figure-html/graph-trips-weekdays-1.png)<!-- -->
...
![](cyclistic_bike_share_rmark_files/figure-html/member-non-member-graph-1.png)<!-- -->
...
![](cyclistic_bike_share_rmark_files/figure-html/total-trips-and-percentage-1.png)<!-- -->
...
![](cyclistic_bike_share_rmark_files/figure-html/trip-duration-1.png)<!-- -->
...
![](cyclistic_bike_share_rmark_files/figure-html/weekend-hourly-traffic-1.png)<!-- -->
...
![](cyclistic_bike_share_rmark_files/figure-html/weekend-hourly-traffic-2.png)<!-- -->
...
![](cyclistic_bike_share_rmark_files/figure-html/Sat-Sun-Peak-Patterns-1.png)<!-- -->
...
3. Casual riders exceed trips exceed regualr member trips on weekends and account for more than 50% of the trips on these two days.
